# Test Results — Customer 13

**Generated:** 2026-02-25 21:24:54
...
|-------|-------|
| **Result** | ✅ **PASS** |
| **Message** | Cleanup complete: customer 13, 21 rows deleted, 394 files removed |
| **Duration** | 0.57s |
| **API Calls** | 2 |
...
```json
{
  ...
  "details": {
    ...
    "filesystem_preview": {
      "directories_found": [
        "/home/user/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer13-dc2_s"
      ],
      "directories_removed": [],
      "files_removed": 394,
      "bytes_freed": 8603060
