...
def main():
    ...
    parser.add_argument('--weights', default=None, help='DC2_S pillar weights as JSON string, e.g. \'{"P1":0.15,"P2":0.20,"P3":0.25,"P4":0.15,"P5":0.25}\'')
    parser.add_argument('--enabled-pillars', default=None, help='Enabled pillar codes as JSON list, e.g. \'["P1","P2","P3","P4","P5"]\'')
    parser.add_argument('--enabled-kpis', default=None, help='Enabled KPI codes as JSON list, e.g. \'["P1-KPI1","P2-KPI1",...]\'')
