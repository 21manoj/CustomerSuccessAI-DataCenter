...
class ProjectListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        return filter_projects_for_user(
            Project.objects.select_related("need", "lead", "program").prefetch_related("owners"),
            self.request.user,
        )
...
class ProjectDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_queryset(self):
        return filter_projects_for_user(
            Project.objects.select_related("need", "lead", "program").prefetch_related(
...
class ProjectUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_queryset(self):
        return filter_projects_for_user(
            Project.objects.select_related("program").prefetch_related("attachments", "owners"),
            self.request.user,
        )
