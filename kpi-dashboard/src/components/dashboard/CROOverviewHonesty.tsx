    ...
    <div className="mb-4 rounded-lg border border-cyan-900/40 bg-cyan-950/20 px-4 py-2.5">
      ...
      {!collapsed && (
        <ul className="mt-2 space-y-1.5 text-[10px] text-gray-400 list-disc list-inside leading-relaxed">
          ...
          <li>
            <span className="text-gray-300">Forward NRR</span> — 90d health-weighted projection here;
            realized / Wizard B NRR is on CFO Overview.
          </li>
          <li>
      ...
      {collapsed && (
        <p className="text-[9px] text-gray-500 mt-1">
          Confirmed graph $ ≠ ARR exposure · Forward NRR ≠ realized · expand for definitions
        </p>
      )}
    </div>
  );
