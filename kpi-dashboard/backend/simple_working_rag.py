#!/usr/bin/env python3
"""
Simple Working RAG System - Guaranteed to work
"""
...
class SimpleWorkingRAG:
    ...
    def build_knowledge_base(self, customer_id: int):
        ...
        print(f"🔍 Building simple working knowledge base for customer {customer_id}...")
        ...
        print(f"✅ Simple working knowledge base built with {len(self.data)} records")
...
# Global instance
simple_working_rag = SimpleWorkingRAG()
