...
class IntegrationTester:
    def __init__(self, base_dir: str = None):
        self.base_dir = Path(base_dir or os.environ.get(
            'BASE_DIR', 
            os.path.expanduser('~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s')
        ))
        self.results = {}
    ...
    def test_phase_4_qdrant(self) -> bool:
        ...
        try:
            ...
            required = [
                'kpi_dashboard_vectors_customer_10',
            ]
            
            optional = [
                'journey_weeks_customer_10',
                'journey_signals_customer_10',
                'journey_training_customer_10',
            ]
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            'journey/data/phase1/account_20007_events.csv',
            'journey/data/phase2/account_20001_events.csv',
            'journey/data/phase2/account_20003_events.csv',
