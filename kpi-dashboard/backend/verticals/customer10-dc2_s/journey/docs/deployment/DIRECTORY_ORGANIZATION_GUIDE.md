...
**Base Path:** `~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s/`
...
│   │   │   ├── phase1/
│   │   │   │   ├── account_20007_events.csv
│   │   │   │   ├── account_20007_journey.json
│   │   │   │   └── account_20007_report.md
│   │   │   ├── phase2/
│   │   │   │   ├── account_20001_events.csv
│   │   │   │   ├── account_20001_journey.json
│   │   │   │   ├── account_20001_report.md
│   │   │   │   ├── account_20003_events.csv
│   │   │   │   ├── account_20003_journey.json
│   │   │   │   └── account_20003_report.md
│   │   │   └── phase3/
...
│   │   │   ├── account_20001_milestones.csv
│   │   │   ├── account_20003_milestones.csv
│   │   │   ├── account_20007_milestones.csv
...
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s/
...
BASE_DIR=~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s
JOURNEY_DIR=$BASE_DIR/journey

# Move Phase 1 data files
mv 1767800625205_account_20007_events.csv $JOURNEY_DIR/data/raw/phase1/account_20007_events.csv
mv 1767800625205_account_20007_journey.json $JOURNEY_DIR/data/raw/phase1/account_20007_journey.json
mv 1767800625205_account_20007_report.md $JOURNEY_DIR/data/raw/phase1/account_20007_report.md

# Move Phase 1 script
mv journey_pattern_generator.py $JOURNEY_DIR/scripts/phase1/

# Move Phase 2 data files (account 20000)
mv 1767800625203_account_20001_events.csv $JOURNEY_DIR/data/raw/phase2/account_20001_events.csv
mv 1767800625204_account_20001_journey.json $JOURNEY_DIR/data/raw/phase2/account_20001_journey.json
mv 1767800625204_account_20001_report.md $JOURNEY_DIR/data/raw/phase2/account_20001_report.md

# Move Phase 2 data files (account {ACCOUNT_ID_START+2})
mv 1767800625205_account_20003_events.csv $JOURNEY_DIR/data/raw/phase2/account_20003_events.csv
mv 1767800625205_account_20003_journey.json $JOURNEY_DIR/data/raw/phase2/account_20003_journey.json
mv 1767800625205_account_20003_report.md $JOURNEY_DIR/data/raw/phase2/account_20003_report.md
...
# data/raw/phase1:   account_20007_*.csv/json/md
# data/raw/phase2:   account_20001_*, account_20003_*
...
```bash
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s/journey
...
# Should show: 3 files (events, journey, report for account 20007)

echo "Phase 2 files:"
ls -1 data/raw/phase2/ | wc -l
# Should show: 6 files (3 files × 2 accounts: 20000, {ACCOUNT_ID_START+2})
