...
# Should see:
# ✅ 1767800625203_account_20001_events.csv
# ✅ 1767800625205_account_20003_events.csv  
# ✅ 1767800625205_account_20007_events.csv
# ✅ all_accounts_kpis.csv
# ✅ kpi_metadata.json
# ✅ 1767800625204_account_20001_journey.json
# ✅ 1767800625205_account_20003_journey.json
# ✅ 1767800625205_account_20007_journey.json
```
...
# ✅ account_20007_milestones.csv (3 milestones - crisis recovery)
# ✅ account_20003_milestones.csv (2 milestones - churn)
# ✅ account_20001_milestones.csv (1 milestone - expansion)
...
20007,30,2024-07-22,expansion_decision_approved,"$400K expansion...",400000,...
```
...
-- Should show 3 accounts: 20000, {ACCOUNT_ID_START+2}, 20007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_10
...
- [x] **Accounts:** 3 accounts (20000, {ACCOUNT_ID_START+2}, 20007)
...
```
3 Accounts:
├─ Account 20000 (CloudScale AI Labs)
...
│
└─ Account 20007 (Legacy Manufacturing Corp)
