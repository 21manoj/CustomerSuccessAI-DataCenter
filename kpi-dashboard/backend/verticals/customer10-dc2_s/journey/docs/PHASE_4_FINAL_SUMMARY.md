...
### **Account 20007 (Crisis-Recovery) - 3 Milestones**
```
...
### **Account 20000 (Proactive-Growth) - 1 Milestone**
```
...
### **Account 20007 - Prediction at Week 5**
```json
{
...
### **Account 20000 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
### **Data Generation**
- `generate_milestones_phase4.py` - Milestone label generator
- `account_20007_milestones.csv` - Crisis-recovery milestones
- `account_20003_milestones.csv` - Churn milestones
- `account_20001_milestones.csv` - Expansion milestones
...
# Creates collection: journey_training_vectors_customer_10
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_10 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 20000 exists in BOTH production and training
...
Contains: Real production accounts 20000-20010
...
```
Collection: journey_training_vectors_customer_10
Contains: Synthetic accounts 20000, {ACCOUNT_ID_START+2}, 20007
...
# Search training data for Account 20007
results = client.search(
    collection_name="journey_training_vectors_customer_10",
    query_vector=query_embedding,
    query_filter={
        "must": [
            {"key": "account_id", "match": {"value": 20007}},
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 20000}}]}
)
