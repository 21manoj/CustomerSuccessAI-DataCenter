...
- ✅ **49 weeks** for Account 20007 (crisis-recovery)
- ✅ **22 weeks** for Account {ACCOUNT_ID_START+2} (ignored-churn)
- ✅ **21 weeks** for Account 20000 (proactive-growth)

### **3. Export Files**
- ✅ `account_20007_kpis.csv` - Crisis recovery KPIs
- ✅ `account_20003_kpis.csv` - Churn pattern KPIs
- ✅ `account_20001_kpis.csv` - Growth pattern KPIs
...
### **Account 20007: Crisis-Recovery Pattern**
...
**Account 20000 hit ALL 5 signals at Week 8** → Expansion at Week 15 ✅
...
**2. Crisis Prediction:**
- Account 20007 Week 4-5: KPIs degrade before crisis
- Uptime drift, ticket volume increase, NPS drop
- **Signal Analyst would predict incident 1 week early**

**3. Expansion Timing:**
- Account 20000 Week 6-8: Capacity signals strengthen
...
**account_20007_kpis.csv** (49 weeks, 1,715 KPIs)
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
20007,Legacy Manufacturing Corp,1,2024-01-01,90.08,healthy,22,91.19,...
20007,Legacy Manufacturing Corp,5,2024-01-29,34.86,crisis,4,25.05,...
...
```

**account_20003_kpis.csv** (22 weeks, 770 KPIs)
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
...
**account_20001_kpis.csv** (21 weeks, 735 KPIs)
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
20000,CloudScale AI Labs,1,2024-01-01,92.45,healthy,24,89.12,...
20000,CloudScale AI Labs,21,2024-05-20,98.9,growth,27,95.34,...
...
```
...
"Capacity (S1) above 85% + Growth (S2) above 20% = expansion window. Account 20000 hit this at Week 8, we closed expansion at Week 15."
