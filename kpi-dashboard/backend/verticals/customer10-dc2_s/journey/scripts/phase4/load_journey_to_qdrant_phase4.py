...
- Isolated from production (kpi_dashboard_vectors_customer_10)
- Contains: 3 accounts (20000, {ACCOUNT_ID_START+2}, 20007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_10"
CUSTOMER_ID = 10
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [20007, {ACCOUNT_ID_START+2}, 20000]
