#!/usr/bin/env python3
"""
Embed Customer 10 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 10 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 10 data loaded
...
CUSTOMER_ID = 10
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_10"  # New naming convention!
...
print(f"   2. Test queries for Customer 10 accounts (20000-20010)")
