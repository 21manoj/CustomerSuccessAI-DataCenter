# Customer 10 Data Directory

Upload your data files here. Required files:

## Required Files

1. **accounts.csv** - Account list with customer_id = 10
...
```bash
cd /Users/manojgupta/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer10-dc2_s/scripts
python3 02_load_customer10_data_SMART.py
```
