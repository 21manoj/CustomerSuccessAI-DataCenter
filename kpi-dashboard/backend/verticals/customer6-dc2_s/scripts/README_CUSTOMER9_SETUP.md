# Customer 6 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 6 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 6 test environment.
...
### 2. **02_load_customer6_data.py** (14 KB)
Loads all Customer 6 CSV files into PostgreSQL.
...
- Customer 6 specific validation
...
# Run loader
python3 02_load_customer6_data.py
...
- Collection: `kpi_dashboard_vectors_customer_6`
...
#   🎉 Customer 6 test environment is ready!
```
...
**Step 2: Load Customer 6 Data (3 min)**
```bash
python3 02_load_customer6_data.py
...
## 🎯 Customer 6 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 16000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_6",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 6:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=16000&customer_id = 6
...
# Should see: 'kpi_dashboard_vectors_customer_6'
```
...
- `/mnt/user-data/outputs/` - All Customer 6 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer6_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_6`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 6 test environment is complete and ready for Signal Analyst testing.**
