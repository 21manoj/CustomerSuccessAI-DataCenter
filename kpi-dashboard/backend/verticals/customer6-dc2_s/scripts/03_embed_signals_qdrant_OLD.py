#!/usr/bin/env python3
"""
Embed Customer 6 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 6 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 6 data loaded
...
print("=" * 80)
print("CUSTOMER 6 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 6
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_6"  # New naming convention!
...
print(f"   2. Test queries for Customer 6 accounts (16000-10010)")
