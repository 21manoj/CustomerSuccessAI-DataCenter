...
- Isolated from production (kpi_dashboard_vectors_customer_332)
- Contains: 3 accounts (342000, {ACCOUNT_ID_START+2}, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_332"
CUSTOMER_ID = 332
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, {ACCOUNT_ID_START+2}, 342000]
