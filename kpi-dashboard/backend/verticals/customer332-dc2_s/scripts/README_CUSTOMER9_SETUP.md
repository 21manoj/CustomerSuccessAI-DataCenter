# Customer 332 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 332 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 332 test environment.
...
### 2. **02_load_customer332_data.py** (14 KB)
Loads all Customer 332 CSV files into PostgreSQL.
...
- Customer 332 specific validation
...
# Run loader
python3 02_load_customer332_data.py
...
- Collection: `kpi_dashboard_vectors_customer_332`
...
#   🎉 Customer 332 test environment is ready!
```
...
**Step 2: Load Customer 332 Data (3 min)**
```bash
python3 02_load_customer332_data.py
...
## 🎯 Customer 332 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 342000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_332",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 332:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=342000&customer_id = 332
...
# Should see: 'kpi_dashboard_vectors_customer_332'
```
...
- [x] Create test data (Customer 332)
...
### Data Privacy
Customer 332 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 332 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer332_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_332`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 332 test environment is complete and ready for Signal Analyst testing.**
