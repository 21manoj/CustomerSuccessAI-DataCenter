#!/usr/bin/env python3
"""
Embed Customer 8 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 8 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 8 data loaded
...
print("=" * 80)
print("CUSTOMER 8 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 8
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_8"  # New naming convention!
...
print(f"   2. Test queries for Customer 8 accounts (18000-10010)")
