...
-- Should show 3 accounts: 18000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_8
...
- [x] **Accounts:** 3 accounts (18000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 18000 (CloudScale AI Labs)
