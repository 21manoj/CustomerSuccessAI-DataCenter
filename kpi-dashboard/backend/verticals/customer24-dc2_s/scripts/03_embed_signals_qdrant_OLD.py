#!/usr/bin/env python3
"""
Embed Customer 24 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 24 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 24 data loaded
...
print("=" * 80)
print("CUSTOMER 24 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 24
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_24"  # New naming convention!
...
print(f"   2. Test queries for Customer 24 accounts (34000-10010)")
