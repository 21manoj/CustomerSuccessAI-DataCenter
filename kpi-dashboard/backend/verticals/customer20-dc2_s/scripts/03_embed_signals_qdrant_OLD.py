#!/usr/bin/env python3
"""
Embed Customer 20 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 20 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 20 data loaded
...
print("=" * 80)
print("CUSTOMER 20 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 20
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_20"  # New naming convention!
...
print(f"   2. Test queries for Customer 20 accounts (30000-10010)")
