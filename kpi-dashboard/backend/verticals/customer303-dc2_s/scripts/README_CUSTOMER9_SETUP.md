# Customer 303 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 303 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 303 test environment.
...
### 2. **02_load_customer303_data.py** (14 KB)
Loads all Customer 303 CSV files into PostgreSQL.
...
- Customer 303 specific validation
...
# Run loader
python3 02_load_customer303_data.py
...
- Collection: `kpi_dashboard_vectors_customer_303`
...
#   🎉 Customer 303 test environment is ready!
```
...
**Step 2: Load Customer 303 Data (3 min)**
```bash
python3 02_load_customer303_data.py
...
## 🎯 Customer 303 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 313000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_303",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 303:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=313000&customer_id = 303
...
# Should see: 'kpi_dashboard_vectors_customer_303'
```
...
- [x] Create test data (Customer 303)
...
### Data Privacy
Customer 303 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 303 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer303_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_303`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 303 test environment is complete and ready for Signal Analyst testing.**
