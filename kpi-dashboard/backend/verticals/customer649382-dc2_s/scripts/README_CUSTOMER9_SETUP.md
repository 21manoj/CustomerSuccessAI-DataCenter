# Customer 649382 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 649382 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 649382 test environment.
...
### 2. **02_load_customer649382_data.py** (14 KB)
Loads all Customer 649382 CSV files into PostgreSQL.
...
- Customer 649382 specific validation
...
# Run loader
python3 02_load_customer649382_data.py
...
- ✅ No orphaned records
- ✅ Customer 649382 has 10 accounts
...
- Collection: `kpi_dashboard_vectors_customer_649382`
...
#   🎉 Customer 649382 test environment is ready!
```
...
**Step 2: Load Customer 649382 Data (3 min)**
```bash
python3 02_load_customer649382_data.py
...
## 🎯 Customer 649382 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 649392000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_649382",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 649382:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=649392000&customer_id = 649382
...
# Should see: 'kpi_dashboard_vectors_customer_649382'
```
...
- [x] Create test data (Customer 649382)
...
### Data Privacy
Customer 649382 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 649382 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer649382_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_649382`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 649382 test environment is complete and ready for Signal Analyst testing.**
