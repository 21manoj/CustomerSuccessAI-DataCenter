#!/usr/bin/env python3
"""
Embed Customer 649382 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 649382 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 649382 data loaded
...
print("=" * 80)
print("CUSTOMER 649382 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 649382
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_649382"  # New naming convention!
...
print(f"   2. Test queries for Customer 649382 accounts (649392000-10010)")
