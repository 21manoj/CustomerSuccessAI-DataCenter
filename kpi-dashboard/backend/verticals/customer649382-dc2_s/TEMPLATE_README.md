...
- `649382` - Customer ID (e.g., 10)
- `dc2_s` - Vertical slug (e.g., 'dc2_s')
- `649392000` - Starting account ID (calculated as 10000 + customer_id * 1000)
...
2. Update `scripts/02_load_customer649382_data_SMART.py` if needed
