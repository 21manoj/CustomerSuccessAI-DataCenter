...
### **Account 649392000 (Proactive-Growth) - 1 Milestone**
```
...
### **Account 649392000 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
# Creates collection: journey_training_vectors_customer_649382
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_649382 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 649392000 exists in BOTH production and training
...
Contains: Real production accounts 649392000-10010
...
```
Collection: journey_training_vectors_customer_649382
Contains: Synthetic accounts 649392000, {ACCOUNT_ID_START+2}, 10007
...
results = client.search(
    collection_name="journey_training_vectors_customer_649382",
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 649392000}}]}
)
