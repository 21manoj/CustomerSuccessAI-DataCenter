#!/usr/bin/env python3
"""
Embed Customer 33 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 33 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 33 data loaded
...
print("=" * 80)
print("CUSTOMER 33 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 33
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_33"  # New naming convention!
...
print(f"   2. Test queries for Customer 33 accounts (43000-10010)")
