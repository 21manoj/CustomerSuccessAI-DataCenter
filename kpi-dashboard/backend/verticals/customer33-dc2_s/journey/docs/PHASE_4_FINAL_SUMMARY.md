...
### **Account 43000 (Proactive-Growth) - 1 Milestone**
```
...
### **Account 43000 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
# Creates collection: journey_training_vectors_customer_33
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_33 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 43000 exists in BOTH production and training
...
Contains: Real production accounts 43000-10010
...
```
Collection: journey_training_vectors_customer_33
Contains: Synthetic accounts 43000, {ACCOUNT_ID_START+2}, 10007
...
results = client.search(
    collection_name="journey_training_vectors_customer_33",
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 43000}}]}
)
