...
- Isolated from production (kpi_dashboard_vectors_customer_320)
- Contains: 3 accounts (330000, {ACCOUNT_ID_START+2}, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_320"
CUSTOMER_ID = 320
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, {ACCOUNT_ID_START+2}, 330000]
