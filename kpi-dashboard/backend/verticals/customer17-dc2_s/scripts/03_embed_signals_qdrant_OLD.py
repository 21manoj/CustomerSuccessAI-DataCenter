#!/usr/bin/env python3
"""
Embed Customer 17 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 17 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 17 data loaded
...
print("=" * 80)
print("CUSTOMER 17 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 17
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_17"  # New naming convention!
...
print(f"   2. Test queries for Customer 17 accounts ({ACCOUNT_ID_START}-10010)")
