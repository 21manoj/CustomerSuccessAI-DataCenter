# Customer 17 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 17 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 17 test environment.
...
### 2. **02_load_customer17_data.py** (14 KB)
Loads all Customer 17 CSV files into PostgreSQL.
...
- Customer 17 specific validation
...
# Run loader
python3 02_load_customer17_data.py
...
#   🎉 Customer 17 test environment is ready!
```
...
**Step 2: Load Customer 17 Data (3 min)**
```bash
python3 02_load_customer17_data.py
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_17",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 17:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id={ACCOUNT_ID_START}&customer_id = 17
...
# Should see: 'kpi_dashboard_vectors_customer_17'
```
...
- [x] Create test data (Customer 17)
...
- `/mnt/user-data/outputs/` - All Customer 17 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer17_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_17`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 17 test environment is complete and ready for Signal Analyst testing.**
