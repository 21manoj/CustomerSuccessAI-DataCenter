...
**Key Findings:**
- ✅ Same 3 accounts ({ACCOUNT_ID_START}, {ACCOUNT_ID_START+2}, 10007)
...
- `journey_account_id` → Mapped from account_id ({ACCOUNT_ID_START}→1, {ACCOUNT_ID_START+2}→2, 10007→3)
...
{ACCOUNT_ID_START},     1,    2024, 92.5,   healthy, 22, 89, ..., 77
```
...
### **Your Phase 2 Data:**
```
Account {ACCOUNT_ID_START}: CloudScale AI Labs (proactive_growth, 21 weeks)
...
**Events:**
```
Account {ACCOUNT_ID_START}: 34 events
...
**KPIs:**
```
Account {ACCOUNT_ID_START}: 21 weeks × 35 KPIs = 735 data points
