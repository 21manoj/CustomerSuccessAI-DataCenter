...
# Creates collection: journey_training_vectors_customer_17
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_17 (production)
```
...
```
Collection: journey_training_vectors_customer_17
...
results = client.search(
    collection_name="journey_training_vectors_customer_17",
