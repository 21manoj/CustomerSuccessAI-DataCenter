...
**Environment:** Customer ID = 9, Account IDs 10001-10010
...
Narrative Accounts: 10001, 10003, 10007
```
...
Actual: Lower due to Account 10003 churn in May
...
By Account:
├─ 10001-10002, 10004-10010: 396 measurements each (12 months × 33 KPIs)
└─ 10003: 132 measurements (4 months × 33 KPIs, churned in May)
```
...
By Account:
├─ 10001 Success Story: 10 executions
├─ 10007 Recovery: 6 executions
├─ 10004 Rocket Ship: 5 executions
├─ 10008 Strategic Expansion: 4 executions
├─ 10002 Near-Miss: 3 executions
└─ 10003 Churned: 0 executions ❌ (demonstrates failure)
```
...
└─ Account 10003 × 5 months: 5 records (churned)
...
Range: 35 (Account 10007 Feb crisis) - 99 (Account 10001 Dec)
```
...
### **✅ Account 10001: Success Story (CloudScale AI Labs)**
```
...
### **❌ Account 10003: Churned (Quantum Computing Corp)**
```
...
✅ One failure case (10003) demonstrates missed signals
```
...
├─ 10001: 10 executions → 100% ARR growth
...
└─ 10003: 0 executions → 100% churn ($3.8M lost)
...
├─ 10001: Detected at 78% util, 18% growth → $5M expansion
...
```
Scripts to create:
├─ load_customer9_all.py (master loader)
...
**Test Environment:** Isolated (customer_id=9)
