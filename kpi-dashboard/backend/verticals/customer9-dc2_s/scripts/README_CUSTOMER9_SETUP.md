# Customer 9 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 9 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 9 test environment.
...
### 2. **02_load_customer9_data.py** (14 KB)
Loads all Customer 9 CSV files into PostgreSQL.
...
- Customer 9 specific validation
...
# Run loader
python3 02_load_customer9_data.py
...
#   🎉 Customer 9 test environment is ready!
```
...
**Step 2: Load Customer 9 Data (3 min)**
```bash
python3 02_load_customer9_data.py
...
## 🎯 Customer 9 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 10001 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
| 10002 | Recovery | Recovery Phase | 87 | $4.2M | ✅ Recovering |
| 10003 | Failure | Churned | 25 | $0 | ❌ Churned |
...
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=10001&customer_id=9
...
# Should see: 'kpi_dashboard_vectors_customer_9'
```
...
- `/mnt/user-data/outputs/` - All Customer 9 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer9_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_9`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 9 test environment is complete and ready for Signal Analyst testing.**
