...
- Isolated from production (kpi_dashboard_vectors_customer_9)
- Contains: 3 accounts (10001, 10003, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_9"
CUSTOMER_ID = 9
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, 10003, 10001]
