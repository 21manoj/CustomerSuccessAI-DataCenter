...
def generate_sample_predictions(session, journey_account_id, account_id, final_outcome, milestones_file):
    ...
    elif account_id == '10003':  # Ignored-Churn
    ...
    elif account_id == '10001':  # Proactive-Growth
...
def load_metadata(session, phase, accounts_loaded, events_loaded, kpis_loaded):
    ...
    patterns_list = [
        ...
        {'account_id': '10003', 'pattern': 'ignored_churn', 'outcome': 'churned'},
        {'account_id': '10001', 'pattern': 'proactive_growth', 'outcome': 'expanded'}
    ]
