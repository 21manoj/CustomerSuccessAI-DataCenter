...
### **Account 10003 - Prediction at Week 3**
```json
{
...
### **Account 10001 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
# Creates collection: journey_training_vectors_customer_9
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_9 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 10001 exists in BOTH production and training
...
Contains: Real production accounts 10001-10010
...
```
Collection: journey_training_vectors_customer_9
Contains: Synthetic accounts 10001, 10003, 10007
...
results = client.search(
    collection_name="journey_training_vectors_customer_9",
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 10001}}]}
)
