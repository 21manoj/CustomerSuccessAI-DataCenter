...
-- Should show 3 accounts: 10001, 10003, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_9
...
- [x] **Accounts:** 3 accounts (10001, 10003, 10007)
...
```
3 Accounts:
├─ Account 10001 (CloudScale AI Labs)
...
│
├─ Account 10003 (Quantum Computing Corp)
