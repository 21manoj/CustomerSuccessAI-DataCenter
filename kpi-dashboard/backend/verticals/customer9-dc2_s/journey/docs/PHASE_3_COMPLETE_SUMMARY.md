...
- ✅ **22 weeks** for Account 10003 (ignored-churn)
- ✅ **21 weeks** for Account 10001 (proactive-growth)
...
**Account 10001 hit ALL 5 signals at Week 8** → Expansion at Week 15 ✅
...
- Account 10003 Week 1-4: All warning signals present
...
**3. Expansion Timing:**
- Account 10001 Week 6-8: Capacity signals strengthen
...
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
10003,Quantum Computing Corp,1,2024-01-01,68.51,at_risk,7,45.23,...
10003,Quantum Computing Corp,22,2024-05-20,19.6,churned,2,18.45,...
...
```
...
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
10001,CloudScale AI Labs,1,2024-01-01,92.45,healthy,24,89.12,...
10001,CloudScale AI Labs,21,2024-05-20,98.9,growth,27,95.34,...
...
```
...
### **For CSMs:**
"Week 1 of Account 10003 shows 45% GPU utilization - this is a RED FLAG. If Signal Analyst had been watching, we would have intervened and saved $3.8M."

### **For Product Managers:**
"Capacity (S1) above 85% + Growth (S2) above 20% = expansion window. Account 10001 hit this at Week 8, we closed expansion at Week 15."
