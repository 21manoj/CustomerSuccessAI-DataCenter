...
-- Should show 3 accounts: {ACCOUNT_ID_START}, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_{CUSTOMER_ID}
...
- [x] **Accounts:** 3 accounts ({ACCOUNT_ID_START}, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account {ACCOUNT_ID_START} (CloudScale AI Labs)
