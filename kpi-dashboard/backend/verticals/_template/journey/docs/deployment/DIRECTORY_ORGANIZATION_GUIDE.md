...
**Base Path:** `~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer{CUSTOMER_ID}-dc2_s/`
...
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer{CUSTOMER_ID}-dc2_s/
...
BASE_DIR=~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer{CUSTOMER_ID}-dc2_s
...
# Move Phase 2 data files (account {ACCOUNT_ID_START})
...
```bash
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer{CUSTOMER_ID}-dc2_s/journey
...
# Should show: 6 files (3 files × 2 accounts: {ACCOUNT_ID_START}, {ACCOUNT_ID_START+2})
