...
- Isolated from production (kpi_dashboard_vectors_customer_{CUSTOMER_ID})
- Contains: 3 accounts ({ACCOUNT_ID_START}, {ACCOUNT_ID_START+2}, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_{CUSTOMER_ID}"
CUSTOMER_ID = {CUSTOMER_ID}
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, {ACCOUNT_ID_START+2}, {ACCOUNT_ID_START}]
