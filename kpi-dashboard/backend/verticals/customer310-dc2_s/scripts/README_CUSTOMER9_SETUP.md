# Customer 310 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 310 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 310 test environment.
...
### 2. **02_load_customer310_data.py** (14 KB)
Loads all Customer 310 CSV files into PostgreSQL.
...
- Customer 310 specific validation
...
# Run loader
python3 02_load_customer310_data.py
...
- Collection: `kpi_dashboard_vectors_customer_310`
...
#   🎉 Customer 310 test environment is ready!
```
...
**Step 2: Load Customer 310 Data (3 min)**
```bash
python3 02_load_customer310_data.py
...
## 🎯 Customer 310 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 320000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_310",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 310:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=320000&customer_id = 310
...
# Should see: 'kpi_dashboard_vectors_customer_310'
```
...
- [x] Create test data (Customer 310)
...
### Data Privacy
Customer 310 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 310 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer310_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_310`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 310 test environment is complete and ready for Signal Analyst testing.**
