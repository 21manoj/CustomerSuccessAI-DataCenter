...
**Key Findings:**
- ✅ Same 3 accounts (320000, {ACCOUNT_ID_START+2}, 10007)
...
- `journey_account_id` → Mapped from account_id (320000→1, {ACCOUNT_ID_START+2}→2, 10007→3)
...
320000,     1,    2024, 92.5,   healthy, 22, 89, ..., 77
```
...
### **Your Phase 2 Data:**
```
Account 320000: CloudScale AI Labs (proactive_growth, 21 weeks)
...
**KPIs:**
```
Account 320000: 21 weeks × 35 KPIs = 735 data points
