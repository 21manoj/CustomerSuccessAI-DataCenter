...
class IntegrationTester:
    def __init__(self, base_dir: str = None):
        self.base_dir = Path(base_dir or os.environ.get(
            'BASE_DIR', 
            os.path.expanduser('~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer304-dc2_s')
        ))
        self.results = {}
    ...
    def test_phase_4_qdrant(self) -> bool:
        ...
        try:
            ...
            required = [
                'kpi_dashboard_vectors_customer_304',
            ]
            
            optional = [
                'journey_weeks_customer_304',
                'journey_signals_customer_304',
                'journey_training_customer_304',
            ]
