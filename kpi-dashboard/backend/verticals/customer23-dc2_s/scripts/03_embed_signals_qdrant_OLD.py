#!/usr/bin/env python3
"""
Embed Customer 23 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 23 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 23 data loaded
...
print("=" * 80)
print("CUSTOMER 23 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 23
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_23"  # New naming convention!
...
print(f"   2. Test queries for Customer 23 accounts (33000-10010)")
