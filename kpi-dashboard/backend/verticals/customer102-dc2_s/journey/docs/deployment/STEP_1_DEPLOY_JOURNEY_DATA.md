...
-- Should show 3 accounts: 112000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_102
...
- [x] **Accounts:** 3 accounts (112000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 112000 (CloudScale AI Labs)
