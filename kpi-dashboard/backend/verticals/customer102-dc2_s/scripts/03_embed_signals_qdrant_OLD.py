#!/usr/bin/env python3
"""
Embed Customer 102 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 102 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 102 data loaded
...
print("=" * 80)
print("CUSTOMER 102 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 102
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_102"  # New naming convention!
...
print(f"   2. Test queries for Customer 102 accounts (112000-10010)")
