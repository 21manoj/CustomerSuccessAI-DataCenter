#!/usr/bin/env python3
"""
Embed Customer 288 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 288 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 288 data loaded
...
print("=" * 80)
print("CUSTOMER 288 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 288
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_288"  # New naming convention!
...
print(f"   2. Test queries for Customer 288 accounts (298000-10010)")
