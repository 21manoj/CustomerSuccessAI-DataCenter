...
**Environment:** Customer ID = 9, Account IDs 22000-10010
...
Narrative Accounts: 22000, {ACCOUNT_ID_START+2}, 10007
```
...
By Account:
├─ 22000-{ACCOUNT_ID_START+1}, 10004-10010: 396 measurements each (12 months × 33 KPIs)
...
By Account:
├─ 22000 Success Story: 10 executions
...
Range: 35 (Account 10007 Feb crisis) - 99 (Account 22000 Dec)
```
...
### **✅ Account 22000: Success Story (CloudScale AI Labs)**
```
...
├─ 22000: 10 executions → 100% ARR growth
...
├─ 22000: Detected at 78% util, 18% growth → $5M expansion
...
```
Scripts to create:
├─ load_customer12_all.py (master loader)
...
**Test Environment:** Isolated (CUSTOMER_ID = 12)
