#!/usr/bin/env python3
"""
Embed Customer 2 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 2 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 2 data loaded
...
print("=" * 80)
print("CUSTOMER 2 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 2
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_2"  # New naming convention!
...
print(f"   2. Test queries for Customer 2 accounts (12000-10010)")
