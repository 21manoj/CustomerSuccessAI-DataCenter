...
**Base Path:** `~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer2-dc2_s/`
...
# Move Phase 2 data files (account 12000)
...
```bash
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer2-dc2_s/journey
...
# Should show: 6 files (3 files × 2 accounts: 12000, {ACCOUNT_ID_START+2})
