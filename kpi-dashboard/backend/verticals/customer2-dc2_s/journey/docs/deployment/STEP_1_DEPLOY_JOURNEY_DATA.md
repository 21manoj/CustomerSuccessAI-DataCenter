...
-- Should show 3 accounts: 12000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_2
...
- [x] **Accounts:** 3 accounts (12000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 12000 (CloudScale AI Labs)
