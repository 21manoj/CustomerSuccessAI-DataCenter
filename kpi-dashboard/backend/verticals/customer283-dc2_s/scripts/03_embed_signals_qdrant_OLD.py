#!/usr/bin/env python3
"""
Embed Customer 283 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 283 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 283 data loaded
...
print("=" * 80)
print("CUSTOMER 283 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 283
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_283"  # New naming convention!
...
print(f"   2. Test queries for Customer 283 accounts (293000-10010)")
