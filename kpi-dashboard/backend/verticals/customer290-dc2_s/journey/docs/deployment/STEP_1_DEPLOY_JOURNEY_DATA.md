...
-- Should show 3 accounts: 300000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_290
...
- [x] **Accounts:** 3 accounts (300000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 300000 (CloudScale AI Labs)
