# Customer 290 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 290 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 290 test environment.
...
### 2. **02_load_customer290_data.py** (14 KB)
Loads all Customer 290 CSV files into PostgreSQL.
...
- Customer 290 specific validation
...
# Run loader
python3 02_load_customer290_data.py
...
- Collection: `kpi_dashboard_vectors_customer_290`
...
#   🎉 Customer 290 test environment is ready!
```
...
**Step 2: Load Customer 290 Data (3 min)**
```bash
python3 02_load_customer290_data.py
...
## 🎯 Customer 290 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 300000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_290",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 290:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=300000&customer_id = 290
...
# Should see: 'kpi_dashboard_vectors_customer_290'
```
...
- [x] Create test data (Customer 290)
...
### Data Privacy
Customer 290 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 290 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer290_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_290`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 290 test environment is complete and ready for Signal Analyst testing.**
