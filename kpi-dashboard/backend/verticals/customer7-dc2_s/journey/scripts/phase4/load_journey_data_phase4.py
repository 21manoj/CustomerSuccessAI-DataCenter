...
def generate_sample_predictions(session, journey_account_id, account_id, final_outcome, milestones_file):
    ...
    if account_id == '17007':  # Crisis-Recovery
    ...
    elif account_id == '17000':  # Proactive-Growth
...
def load_metadata(session, phase, accounts_loaded, events_loaded, kpis_loaded):
    ...
    patterns_list = [
        {'account_id': '17007', 'pattern': 'crisis_recovery', 'outcome': 'recovered'},
        {'account_id': '{ACCOUNT_ID_START+2}', 'pattern': 'ignored_churn', 'outcome': 'churned'},
        {'account_id': '17000', 'pattern': 'proactive_growth', 'outcome': 'expanded'}
    ]
...
def main():
    ...
    try:
        # Load each account
        accounts = ['17007', '{ACCOUNT_ID_START+2}', '17000']
        total_events = 0
        total_kpis = 0
