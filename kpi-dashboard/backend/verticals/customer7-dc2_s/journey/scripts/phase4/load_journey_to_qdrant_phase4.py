...
- Isolated from production (kpi_dashboard_vectors_customer_7)
- Contains: 3 accounts (17000, {ACCOUNT_ID_START+2}, 17007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_7"
CUSTOMER_ID = 7
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [17007, {ACCOUNT_ID_START+2}, 17000]
