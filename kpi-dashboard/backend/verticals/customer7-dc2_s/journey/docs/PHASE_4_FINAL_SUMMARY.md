...
### **Account 17007 (Crisis-Recovery) - 3 Milestones**
```
...
### **Account 17000 (Proactive-Growth) - 1 Milestone**
```
...
### **Account 17007 - Prediction at Week 5**
```json
{
...
### **Account 17000 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
### **Data Generation**
- `generate_milestones_phase4.py` - Milestone label generator
- `account_17007_milestones.csv` - Crisis-recovery milestones
- `account_17003_milestones.csv` - Churn milestones
- `account_17001_milestones.csv` - Expansion milestones
...
# Creates collection: journey_training_vectors_customer_7
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_7 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 17000 exists in BOTH production and training
...
Contains: Real production accounts 17000-17010
...
```
Collection: journey_training_vectors_customer_7
Contains: Synthetic accounts 17000, {ACCOUNT_ID_START+2}, 17007
...
# Search training data for Account 17007
results = client.search(
    collection_name="journey_training_vectors_customer_7",
    query_vector=query_embedding,
    query_filter={
        "must": [
            {"key": "account_id", "match": {"value": 17007}},
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 17000}}]}
)
