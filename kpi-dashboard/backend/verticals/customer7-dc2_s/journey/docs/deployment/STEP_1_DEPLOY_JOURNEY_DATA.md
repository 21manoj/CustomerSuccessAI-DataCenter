...
# Should see:
# ✅ 1767800625203_account_17001_events.csv
# ✅ 1767800625205_account_17003_events.csv  
# ✅ 1767800625205_account_17007_events.csv
# ✅ all_accounts_kpis.csv
# ✅ kpi_metadata.json
# ✅ 1767800625204_account_17001_journey.json
# ✅ 1767800625205_account_17003_journey.json
# ✅ 1767800625205_account_17007_journey.json
```
...
# ✅ account_17007_milestones.csv (3 milestones - crisis recovery)
# ✅ account_17003_milestones.csv (2 milestones - churn)
# ✅ account_17001_milestones.csv (1 milestone - expansion)
...
17007,30,2024-07-22,expansion_decision_approved,"$400K expansion...",400000,...
```
...
-- Should show 3 accounts: 17000, {ACCOUNT_ID_START+2}, 17007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_7
...
- [x] **Accounts:** 3 accounts (17000, {ACCOUNT_ID_START+2}, 17007)
...
```
3 Accounts:
├─ Account 17000 (CloudScale AI Labs)
...
│
└─ Account 17007 (Legacy Manufacturing Corp)
