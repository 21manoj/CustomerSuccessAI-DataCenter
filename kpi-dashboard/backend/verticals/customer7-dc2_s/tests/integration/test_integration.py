...
class IntegrationTester:
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            ('journey/data/raw/phase1/account_17007_events.csv', 'journey/data/phase1/account_17007_events.csv'),
            ('journey/data/raw/phase2/account_17001_events.csv', 'journey/data/phase2/account_17001_events.csv'),
            ('journey/data/raw/phase2/account_17003_events.csv', 'journey/data/phase2/account_17003_events.csv'),
