...
class IntegrationTester:
    def __init__(self, base_dir: str = None):
        self.base_dir = Path(base_dir or os.environ.get(
            'BASE_DIR', 
            os.path.expanduser('~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer7-dc2_s')
        ))
        self.results = {}
    ...
    def test_phase_4_qdrant(self) -> bool:
        ...
        try:
            ...
            required = [
                'kpi_dashboard_vectors_customer_7',
            ]
            
            optional = [
                'journey_weeks_customer_7',
                'journey_signals_customer_7',
                'journey_training_customer_7',
            ]
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            'journey/data/phase1/account_17007_events.csv',
            'journey/data/phase2/account_17001_events.csv',
            'journey/data/phase2/account_17003_events.csv',
