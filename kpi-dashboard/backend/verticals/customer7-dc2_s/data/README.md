# Customer 7 Data Directory

Upload your data files here. Required files:

## Required Files

1. **accounts.csv** - Account list with customer_id = 7
...
```bash
cd /Users/manojgupta/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/agents/../verticals/customer7-dc2_s/scripts
python3 02_load_customer7_data_SMART.py
```
