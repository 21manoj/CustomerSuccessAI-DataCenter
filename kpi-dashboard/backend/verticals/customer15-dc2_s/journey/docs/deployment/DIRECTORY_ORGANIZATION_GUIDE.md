...
**Base Path:** `~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer15-dc2_s/`
...
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer15-dc2_s/
...
BASE_DIR=~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer15-dc2_s
...
# Move Phase 2 data files (account 25000)
...
```bash
cd ~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer15-dc2_s/journey
...
# Should show: 6 files (3 files × 2 accounts: 25000, {ACCOUNT_ID_START+2})
