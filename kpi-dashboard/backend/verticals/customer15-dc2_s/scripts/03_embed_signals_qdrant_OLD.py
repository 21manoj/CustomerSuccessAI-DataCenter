#!/usr/bin/env python3
"""
Embed Customer 15 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 15 into Qdrant Cloud
using the latest architecture (Jan 4-5, 2026 updates).

Architecture Updates (Jan 4-5):
- Collection naming: kpi_dashboard_vectors_customer_15
...
Requirements:
    - PostgreSQL with Customer 15 data loaded
...
CUSTOMER_ID = 15
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_15"  # New naming convention!
...
print(f"   2. Test queries for Customer 15 accounts (25000-10010)")
