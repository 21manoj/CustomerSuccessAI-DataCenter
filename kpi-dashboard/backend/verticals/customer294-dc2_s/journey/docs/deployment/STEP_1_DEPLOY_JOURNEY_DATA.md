...
-- Should show 3 accounts: 304000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_294
...
- [x] **Accounts:** 3 accounts (304000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 304000 (CloudScale AI Labs)
