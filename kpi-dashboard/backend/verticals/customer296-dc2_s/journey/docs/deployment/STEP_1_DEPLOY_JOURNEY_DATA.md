...
-- Should show 3 accounts: 306000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_296
...
- [x] **Accounts:** 3 accounts (306000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 306000 (CloudScale AI Labs)
