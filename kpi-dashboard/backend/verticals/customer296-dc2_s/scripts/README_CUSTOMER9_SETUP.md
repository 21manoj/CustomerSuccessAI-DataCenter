# Customer 296 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 296 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 296 test environment.
...
### 2. **02_load_customer296_data.py** (14 KB)
Loads all Customer 296 CSV files into PostgreSQL.
...
- Customer 296 specific validation
...
# Run loader
python3 02_load_customer296_data.py
...
#   🎉 Customer 296 test environment is ready!
```
...
**Step 2: Load Customer 296 Data (3 min)**
```bash
python3 02_load_customer296_data.py
...
## 🎯 Customer 296 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 306000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_296",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 296:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=306000&customer_id = 296
...
# Should see: 'kpi_dashboard_vectors_customer_296'
```
...
- [x] Create test data (Customer 296)
...
### Data Privacy
Customer 296 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 296 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer296_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_296`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 296 test environment is complete and ready for Signal Analyst testing.**
