#!/usr/bin/env python3
"""
Embed Customer 13 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 13 into Qdrant Cloud
using the latest architecture (Jan 4-5, 2026 updates).

Architecture Updates (Jan 4-5):
- Collection naming: kpi_dashboard_vectors_customer_13
...
Requirements:
    - PostgreSQL with Customer 13 data loaded
...
CUSTOMER_ID = 13
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_13"  # New naming convention!
...
print(f"   2. Test queries for Customer 13 accounts (23000-10010)")
