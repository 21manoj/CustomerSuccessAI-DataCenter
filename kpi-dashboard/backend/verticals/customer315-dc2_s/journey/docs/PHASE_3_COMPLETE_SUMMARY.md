...
- ✅ **21 weeks** for Account 325000 (proactive-growth)
...
**Account 325000 hit ALL 5 signals at Week 8** → Expansion at Week 15 ✅
...
**3. Expansion Timing:**
- Account 325000 Week 6-8: Capacity signals strengthen
...
```csv
account_id,account_name,week_number,date,health_score,phase,P1,P2,...,B7
325000,CloudScale AI Labs,1,2024-01-01,92.45,healthy,24,89.12,...
325000,CloudScale AI Labs,21,2024-05-20,98.9,growth,27,95.34,...
...
```
...
"Capacity (S1) above 85% + Growth (S2) above 20% = expansion window. Account 325000 hit this at Week 8, we closed expansion at Week 15."
