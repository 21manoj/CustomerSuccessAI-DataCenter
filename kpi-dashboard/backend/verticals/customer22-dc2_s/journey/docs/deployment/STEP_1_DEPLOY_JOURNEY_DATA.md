...
-- Should show 3 accounts: 32000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_22
...
- [x] **Accounts:** 3 accounts (32000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 32000 (CloudScale AI Labs)
