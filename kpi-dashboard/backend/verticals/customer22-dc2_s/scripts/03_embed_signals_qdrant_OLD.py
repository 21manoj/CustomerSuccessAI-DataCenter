#!/usr/bin/env python3
"""
Embed Customer 22 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 22 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 22 data loaded
...
print("=" * 80)
print("CUSTOMER 22 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 22
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_22"  # New naming convention!
...
print(f"   2. Test queries for Customer 22 accounts (32000-10010)")
