#!/usr/bin/env python3
"""
Embed Customer 5 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 5 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 5 data loaded
...
print("=" * 80)
print("CUSTOMER 5 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 5
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_5"  # New naming convention!
...
print(f"   2. Test queries for Customer 5 accounts (15000-15010)")
