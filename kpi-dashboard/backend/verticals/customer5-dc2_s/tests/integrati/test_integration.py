...
class IntegrationTester:
    def __init__(self, base_dir: str = None):
        self.base_dir = Path(base_dir or os.environ.get(
            'BASE_DIR', 
            os.path.expanduser('~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer5-dc2_s')
        ))
        self.results = {}
    ...
    def test_phase_4_qdrant(self) -> bool:
        ...
        try:
            ...
            required = [
                'kpi_dashboard_vectors_customer_5',
            ]
            
            optional = [
                'journey_weeks_customer_5',
                'journey_signals_customer_5',
                'journey_training_customer_5',
            ]
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            'journey/data/phase1/account_15007_events.csv',
            'journey/data/phase2/account_15001_events.csv',
            'journey/data/phase2/account_15003_events.csv',
