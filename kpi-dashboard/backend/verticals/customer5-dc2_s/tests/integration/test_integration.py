...
class IntegrationTester:
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            ('journey/data/raw/phase1/account_15007_events.csv', 'journey/data/phase1/account_15007_events.csv'),
            ('journey/data/raw/phase2/account_15001_events.csv', 'journey/data/phase2/account_15001_events.csv'),
            ('journey/data/raw/phase2/account_15003_events.csv', 'journey/data/phase2/account_15003_events.csv'),
