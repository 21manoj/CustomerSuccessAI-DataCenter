...
### **Account 15007 (Crisis-Recovery) - 3 Milestones**
```
...
### **Account 15000 (Proactive-Growth) - 1 Milestone**
```
...
### **Account 15007 - Prediction at Week 5**
```json
{
...
### **Account 15000 - Prediction at Week 5**
```json
{
  "predicted_outcome": "expansion",
  "expansion_probability": 85,
...
### **Data Generation**
- `generate_milestones_phase4.py` - Milestone label generator
- `account_15007_milestones.csv` - Crisis-recovery milestones
- `account_15003_milestones.csv` - Churn milestones
- `account_15001_milestones.csv` - Expansion milestones
...
# Creates collection: journey_training_vectors_customer_5
# Loads: 187 events + 3,220 KPIs with embeddings
# Isolated from: kpi_dashboard_vectors_customer_5 (production)
```

**Why Separate Collection:**
- ✅ Zero interference with production data
- ✅ Account 15000 exists in BOTH production and training
...
Contains: Real production accounts 15000-15010
...
```
Collection: journey_training_vectors_customer_5
Contains: Synthetic accounts 15000, {ACCOUNT_ID_START+2}, 15007
...
# Search training data for Account 15007
results = client.search(
    collection_name="journey_training_vectors_customer_5",
    query_vector=query_embedding,
    query_filter={
        "must": [
            {"key": "account_id", "match": {"value": 15007}},
...
prod_results = client.search(
    ...
    query_filter={"must": [{"key": "account_id", "match": {"value": 15000}}]}
)
