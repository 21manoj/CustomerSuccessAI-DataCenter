...
# Should see:
# ✅ 1767800625203_account_15001_events.csv
# ✅ 1767800625205_account_15003_events.csv  
# ✅ 1767800625205_account_15007_events.csv
# ✅ all_accounts_kpis.csv
# ✅ kpi_metadata.json
# ✅ 1767800625204_account_15001_journey.json
# ✅ 1767800625205_account_15003_journey.json
# ✅ 1767800625205_account_15007_journey.json
```
...
# ✅ account_15007_milestones.csv (3 milestones - crisis recovery)
# ✅ account_15003_milestones.csv (2 milestones - churn)
# ✅ account_15001_milestones.csv (1 milestone - expansion)
...
15007,30,2024-07-22,expansion_decision_approved,"$400K expansion...",400000,...
```
...
-- Should show 3 accounts: 15000, {ACCOUNT_ID_START+2}, 15007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_5
...
- [x] **Accounts:** 3 accounts (15000, {ACCOUNT_ID_START+2}, 15007)
...
```
3 Accounts:
├─ Account 15000 (CloudScale AI Labs)
...
│
└─ Account 15007 (Legacy Manufacturing Corp)
