...
- Isolated from production (kpi_dashboard_vectors_customer_5)
- Contains: 3 accounts (15000, {ACCOUNT_ID_START+2}, 15007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_5"
CUSTOMER_ID = 5
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [15007, {ACCOUNT_ID_START+2}, 15000]
