...
- Isolated from production (kpi_dashboard_vectors_customer_333)
- Contains: 3 accounts (343000, {ACCOUNT_ID_START+2}, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_333"
CUSTOMER_ID = 333
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, {ACCOUNT_ID_START+2}, 343000]
