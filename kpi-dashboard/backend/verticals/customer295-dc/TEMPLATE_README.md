...
- `295` - Customer ID (e.g., 10)
- `dc` - Vertical slug (e.g., 'dc2_s')
- `305000` - Starting account ID (calculated as 10000 + customer_id * 1000)
...
2. Update `scripts/02_load_customer295_data_SMART.py` if needed
