...
- Isolated from production (kpi_dashboard_vectors_customer_295)
- Contains: 3 accounts (305000, {ACCOUNT_ID_START+2}, 10007)
...
TRAINING_COLLECTION = "journey_training_vectors_customer_295"
CUSTOMER_ID = 295
VECTOR_SIZE = 1536  # OpenAI text-embedding-3-small
JOURNEY_ACCOUNTS = [10007, {ACCOUNT_ID_START+2}, 305000]
