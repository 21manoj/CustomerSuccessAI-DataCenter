#!/usr/bin/env python3
"""
Embed Customer 4 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 4 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 4 data loaded
...
print("=" * 80)
print("CUSTOMER 4 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 4
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_4"  # New naming convention!
...
print(f"   2. Test queries for Customer 4 accounts (14000-10010)")
