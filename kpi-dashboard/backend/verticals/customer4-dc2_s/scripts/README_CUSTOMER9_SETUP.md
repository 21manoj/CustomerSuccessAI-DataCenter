# Customer 4 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 4 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 4 test environment.
...
### 2. **02_load_customer4_data.py** (14 KB)
Loads all Customer 4 CSV files into PostgreSQL.
...
- Customer 4 specific validation
...
# Run loader
python3 02_load_customer4_data.py
...
- Collection: `kpi_dashboard_vectors_customer_4`
...
#   🎉 Customer 4 test environment is ready!
```
...
**Step 2: Load Customer 4 Data (3 min)**
```bash
python3 02_load_customer4_data.py
...
## 🎯 Customer 4 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 14000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_4",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 4:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=14000&customer_id = 4
...
# Should see: 'kpi_dashboard_vectors_customer_4'
```
...
- `/mnt/user-data/outputs/` - All Customer 4 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer4_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_4`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 4 test environment is complete and ready for Signal Analyst testing.**
