...
-- Should show 3 accounts: 45000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_35
...
- [x] **Accounts:** 3 accounts (45000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 45000 (CloudScale AI Labs)
