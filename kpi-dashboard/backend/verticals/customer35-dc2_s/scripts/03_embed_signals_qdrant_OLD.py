#!/usr/bin/env python3
"""
Embed Customer 35 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 35 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 35 data loaded
...
print("=" * 80)
print("CUSTOMER 35 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 35
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_35"  # New naming convention!
...
print(f"   2. Test queries for Customer 35 accounts (45000-10010)")
