...
class IntegrationTester:
    def __init__(self, base_dir: str = None):
        self.base_dir = Path(base_dir or os.environ.get(
            'BASE_DIR', 
            os.path.expanduser('~/CustomerSuccessAI-DataCenter/kpi-dashboard/backend/verticals/customer11-dc2_s')
        ))
        self.results = {}
    ...
    def test_phase_2_services(self) -> bool:
        ...
        try:
            ...
            assert 20 <= result.coverage_pct <= 50, f"Coverage should be 20-50%, got {result.coverage_pct}"
    ...
    def test_phase_4_qdrant(self) -> bool:
        ...
        try:
            ...
            required = [
                'kpi_dashboard_vectors_customer_11',
            ]
            
            optional = [
                'journey_weeks_customer_11',
                'journey_signals_customer_11',
                'journey_training_customer_11',
            ]
    ...
    def test_phase_5_data(self) -> bool:
        ...
        data_files = [
            'journey/data/phase1/account_10007_events.csv',
            'journey/data/phase2/account_10001_events.csv',
            'journey/data/phase2/account_10003_events.csv',
            'journey/data/phase3/all_accounts_kpis.csv',
        ]
        ...
        for file_path in data_files:
            ...
            if full_path.exists():
                ...
                print_ok(f"Data file: {file_path} ({size:,} bytes)")
            else:
                print_fail(f"Missing data: {file_path}")
                all_ok = False
    ...
    def test_safety_saas(self) -> bool:
        ...
        try:
            ...
            cur.execute("SELECT COUNT(*) FROM accounts WHERE CUSTOMER_ID = 11")
