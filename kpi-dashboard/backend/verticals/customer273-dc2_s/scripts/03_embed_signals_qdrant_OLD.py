#!/usr/bin/env python3
"""
Embed Customer 273 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 273 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 273 data loaded
...
print("=" * 80)
print("CUSTOMER 273 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 273
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_273"  # New naming convention!
...
print(f"   2. Test queries for Customer 273 accounts (283000-10010)")
