...
-- Should show 3 accounts: 29000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_19
...
- [x] **Accounts:** 3 accounts (29000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 29000 (CloudScale AI Labs)
