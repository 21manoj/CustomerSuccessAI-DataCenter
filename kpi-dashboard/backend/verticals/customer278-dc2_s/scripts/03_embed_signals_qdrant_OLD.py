#!/usr/bin/env python3
"""
Embed Customer 278 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 278 into Qdrant Cloud
...
Requirements:
    - PostgreSQL with Customer 278 data loaded
...
print("=" * 80)
print("CUSTOMER 278 → QDRANT EMBEDDING (Latest Architecture)")
...
CUSTOMER_ID = 278
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_278"  # New naming convention!
...
print(f"   2. Test queries for Customer 278 accounts (288000-10010)")
