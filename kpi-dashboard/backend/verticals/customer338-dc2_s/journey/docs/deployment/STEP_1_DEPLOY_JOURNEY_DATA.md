...
-- Should show 3 accounts: 348000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_338
...
- [x] **Accounts:** 3 accounts (348000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 348000 (CloudScale AI Labs)
