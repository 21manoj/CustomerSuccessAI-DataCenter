# Customer 338 Test Environment - Complete Setup Guide
...
Complete SQL and Python scripts for setting up Customer 338 test environment with Signal Analyst integration, incorporating the latest Qdrant architecture changes from January 4-5, 2026.
...
Complete PostgreSQL schema for Customer 338 test environment.
...
### 2. **02_load_customer338_data.py** (14 KB)
Loads all Customer 338 CSV files into PostgreSQL.
...
- Customer 338 specific validation
...
# Run loader
python3 02_load_customer338_data.py
...
- Collection: `kpi_dashboard_vectors_customer_338`
...
#   🎉 Customer 338 test environment is ready!
```
...
**Step 2: Load Customer 338 Data (3 min)**
```bash
python3 02_load_customer338_data.py
...
## 🎯 Customer 338 Test Data Summary

### Accounts (10 Total)

| Account ID | Type | Journey | Health | ARR | Status |
|------------|------|---------|--------|-----|--------|
| 348000 | Success | Healthy Expansion | 99 | $10.0M | ✅ Reference |
...
results = qdrant.search(
    collection_name="kpi_dashboard_vectors_customer_338",
    query_vector=embedding,
    limit=20
)
...
**3. Test with Customer 338:**
```bash
# In UI or API
GET /api/signal_analyst/analyze?account_id=348000&customer_id = 338
...
# Should see: 'kpi_dashboard_vectors_customer_338'
```
...
- [x] Create test data (Customer 338)
...
### Data Privacy
Customer 338 is TEST DATA ONLY:
...
- `/mnt/user-data/outputs/` - All Customer 338 CSV files
- `01_postgresql_schema.sql` - Database schema
- `02_load_customer338_data.py` - Data loader
...
**Qdrant Setup:**
- [ ] Collection created: `kpi_dashboard_vectors_customer_338`
- [ ] 354 points uploaded
- [ ] Vector dimension: 3072
- [ ] Test queries work
...
**🎉 Congratulations! Customer 338 test environment is complete and ready for Signal Analyst testing.**
