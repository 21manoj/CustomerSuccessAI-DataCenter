#!/usr/bin/env python3
"""
Embed Customer 14 Signals to Qdrant
===================================

Embeds qualitative signals and KPI metadata for Customer 14 into Qdrant Cloud
using the latest architecture (Jan 4-5, 2026 updates).

Architecture Updates (Jan 4-5):
- Collection naming: kpi_dashboard_vectors_customer_14
...
Requirements:
    - PostgreSQL with Customer 14 data loaded
...
CUSTOMER_ID = 14
COLLECTION_NAME = f"kpi_dashboard_vectors_customer_14"  # New naming convention!
...
print(f"   2. Test queries for Customer 14 accounts (24000-10010)")
