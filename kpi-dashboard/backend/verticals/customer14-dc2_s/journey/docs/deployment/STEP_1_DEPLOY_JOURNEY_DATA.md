...
-- Should show 3 accounts: 24000, {ACCOUNT_ID_START+2}, 10007
...
# Expected output:
# ✅ Creating collection: journey_training_vectors_customer_14
...
- [x] **Accounts:** 3 accounts (24000, {ACCOUNT_ID_START+2}, 10007)
...
```
3 Accounts:
├─ Account 24000 (CloudScale AI Labs)
