#!/usr/bin/env python3
"""
Delete Customers 41-93 and Verify Deletion
==========================================

This script deletes customers with IDs between 41 and 93 (inclusive),
including all related data and customer directories.

Usage:
    python3 delete_customers_41_93.py [--dry-run] [--verify-only]
...
def delete_customer_data(customer_id, dry_run=False):
    ...
    try:
        ...
        # 16.5. Delete account_profiles (before accounts due to FK constraint)
        if account_ids:
...
def main():
    parser = argparse.ArgumentParser(description='Delete customers 41-93 and verify deletion')
    ...
    customer_ids = list(range(41, 94))  # 41 to 93 inclusive
    
    print("="*70)
    print("DELETE CUSTOMERS 41-93")
    print("="*70)
    ...
    with app.app_context():
        ...
        if not existing_customers:
            print("✅ No customers found in range 41-93")
            return 0
        ...
        if all_deleted:
            print("✅ ALL CUSTOMERS 41-93 SUCCESSFULLY DELETED AND VERIFIED")
        else:
