#!/usr/bin/env python3
"""
Simple RAG System for Demo - Uses in-memory vector search
"""
...
class SimpleRAGSystem:
    ...
    def build_knowledge_base(self, customer_id: int):
        ...
        print(f"🔍 Building simple knowledge base for customer {customer_id}...")
        ...
        print(f"✅ Simple knowledge base built with {len(self.data)} records")
